...
#ifndef ORIGINAL_NAV
    bool          Direct;       // Best candidate is in the bounding box to the current NavId
#endif
...
#else
    void Clear()         { ID = SelectScopeId = 0; Window = NULL; DistBox = DistCenter = DistAxial = FLT_MAX; RectRel = ImRect(); Direct = false; }
#endif
};
