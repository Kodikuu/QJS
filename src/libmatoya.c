...
static const JSCFunctionListEntry js_MTY_RenderDesc[] = {
    ...
    JS_PROP_INT32_DEF("filter", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("effect", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("imageWidth", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("imageHeight", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("cropWidth", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("cropHeight", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("viewWidth", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("viewHeight", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_DOUBLE_DEF("aspectRatio", 0.0f, JS_PROP_CONFIGURABLE),
    JS_PROP_DOUBLE_DEF("scale", 0.0f, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_Point[] = {
    JS_PROP_DOUBLE_DEF("x", 0.0f, JS_PROP_CONFIGURABLE),
    JS_PROP_DOUBLE_DEF("y", 0.0f, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_Rect[] = {
    JS_PROP_DOUBLE_DEF("left", 0.0f, JS_PROP_CONFIGURABLE),
    JS_PROP_DOUBLE_DEF("top", 0.0f, JS_PROP_CONFIGURABLE),
    JS_PROP_DOUBLE_DEF("right", 0.0f, JS_PROP_CONFIGURABLE),
    JS_PROP_DOUBLE_DEF("bottom", 0.0f, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_Vtx[] = {
    JS_OBJECT_DEF("pos", js_MTY_Point, 2, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("uv", js_MTY_Point, 2, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("col", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_Cmd[] = {
    JS_OBJECT_DEF("clip", js_MTY_Rect, 4, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("texture", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("elemCount", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("idxOffset", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("vtxOffset", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_CmdList[] = {
    JS_PROP_INT64_DEF("cmd", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT64_DEF("vtx", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT64_DEF("idx", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("cmdLength", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("cmdMax", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("vtxLength", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("vtxMax", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("idxLength", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("idxMax", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_DrawData[] = {
    JS_OBJECT_DEF("displaySize", js_MTY_Point, 2, JS_PROP_CONFIGURABLE),
    JS_PROP_INT64_DEF("cmdList", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("cmdListLength", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("cmdListMax", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("idxTotalLength", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("vtxTotalLength", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("clear", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_Axis[] = {
    JS_PROP_INT32_DEF("usage", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("value", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("min", 0, JS_PROP_CONFIGURABLE),
...
static const JSCFunctionListEntry js_bool_64[] = {
    ...
    JS_PROP_INT32_DEF("2", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("3", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("4", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("5", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("6", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("7", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("8", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("9", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("10", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("11", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("12", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("13", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("14", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("15", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("16", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("17", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("18", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("19", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("20", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("21", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("22", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("23", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("24", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("25", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("26", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("27", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("28", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("29", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("30", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("31", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("32", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("33", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("34", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("35", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("36", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("37", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("38", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("39", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("40", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("41", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("42", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("43", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("44", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("45", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("46", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("47", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("48", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("49", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("50", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("51", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("52", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("53", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("54", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("55", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("56", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("57", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("58", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("59", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("60", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("61", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("62", 0, JS_PROP_CONFIGURABLE),
...
static const JSCFunctionListEntry js_MTY_Axis_16[] = {
    ...
    JS_OBJECT_DEF("2", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("3", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("4", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("5", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("6", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("7", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("8", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("9", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("10", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("11", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("12", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("13", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("14", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("15", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_ControllerEvent[] = {
    JS_OBJECT_DEF("buttons", js_bool_64, 64, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("axes", js_MTY_Axis_16, 16, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("type", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("id", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("vid", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("pid", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("numButtons", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("numAxes", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_KeyEvent[] = {
    JS_PROP_INT32_DEF("key", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("mod", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("pressed", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_ScrollEvent[] = {
    JS_PROP_INT32_DEF("x", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("y", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("pixels", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_ButtonEvent[] = {
    JS_PROP_INT32_DEF("button", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("x", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("y", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("pressed", 0, JS_PROP_CONFIGURABLE),
};
...
static const JSCFunctionListEntry js_MTY_MotionEvent[] = {
    JS_PROP_INT32_DEF("x", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("y", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("relative", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("synth", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_DropEvent[] = {
    JS_PROP_STRING_DEF("name", "", JS_PROP_CONFIGURABLE),
    JS_PROP_INT64_DEF("buf", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_PenEvent[] = {
    JS_PROP_INT32_DEF("flags", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("x", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("y", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("pressure", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("rotation", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("tiltX", 0, JS_PROP_CONFIGURABLE),
...
static const JSCFunctionListEntry js_char_8[] = {
    ...
    JS_PROP_STRING_DEF("2", "", JS_PROP_CONFIGURABLE),
    JS_PROP_STRING_DEF("3", "", JS_PROP_CONFIGURABLE),
    JS_PROP_STRING_DEF("4", "", JS_PROP_CONFIGURABLE),
    JS_PROP_STRING_DEF("5", "", JS_PROP_CONFIGURABLE),
    JS_PROP_STRING_DEF("6", "", JS_PROP_CONFIGURABLE),
    JS_PROP_STRING_DEF("7", "", JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_Event[] = {
    JS_PROP_INT32_DEF("type", 0, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("controller", js_MTY_ControllerEvent, 8, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("scroll", js_MTY_ScrollEvent, 3, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("button", js_MTY_ButtonEvent, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("motion", js_MTY_MotionEvent, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("drop", js_MTY_DropEvent, 3, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("pen", js_MTY_PenEvent, 7, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("key", js_MTY_KeyEvent, 3, JS_PROP_CONFIGURABLE),
    JS_PROP_STRING_DEF("reopenArg", "", JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("hotkey", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("trayID", 0, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("text", js_char_8, 8, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("focus", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_MenuItem[] = {
    JS_PROP_STRING_DEF("label", "", JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("trayID", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_WindowDesc[] = {
    JS_PROP_STRING_DEF("title", "", JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("origin", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("api", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("width", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("height", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("minWidth", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("minHeight", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("x", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("y", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_DOUBLE_DEF("maxHeight", 0.0f, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("fullscreen", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("hidden", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("vsync", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_FileDesc[] = {
    JS_PROP_STRING_DEF("path", "", JS_PROP_CONFIGURABLE),
    JS_PROP_STRING_DEF("name", "", JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("dir", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_FileList[] = {
    JS_PROP_INT64_DEF("files", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT32_DEF("len", 0, JS_PROP_CONFIGURABLE),
};
...
static const JSCFunctionListEntry js_MTY_Atomic64[] = {
    JS_PROP_INT64_DEF("value", 0, JS_PROP_CONFIGURABLE),
};

static const JSCFunctionListEntry js_MTY_ListNode[] = {
    JS_PROP_INT64_DEF("prev", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT64_DEF("next", 0, JS_PROP_CONFIGURABLE),
    JS_PROP_INT64_DEF("value", 0, JS_PROP_CONFIGURABLE),
};
...
static const JSCFunctionListEntry js_exports[] = {
    ...
    JS_OBJECT_DEF("MTY_RenderDesc", js_MTY_RenderDesc, 12, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_Point", js_MTY_Point, 2, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_Rect", js_MTY_Rect, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_Vtx", js_MTY_Vtx, 3, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_Cmd", js_MTY_Cmd, 5, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_CmdList", js_MTY_CmdList, 9, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_DrawData", js_MTY_DrawData, 7, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_Axis", js_MTY_Axis, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_ControllerEvent", js_MTY_ControllerEvent, 8, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_KeyEvent", js_MTY_KeyEvent, 3, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_ScrollEvent", js_MTY_ScrollEvent, 3, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_ButtonEvent", js_MTY_ButtonEvent, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_MotionEvent", js_MTY_MotionEvent, 4, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_DropEvent", js_MTY_DropEvent, 3, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_PenEvent", js_MTY_PenEvent, 7, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_Event", js_MTY_Event, 15, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_MenuItem", js_MTY_MenuItem, 3, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_WindowDesc", js_MTY_WindowDesc, 13, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_FileDesc", js_MTY_FileDesc, 3, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_FileList", js_MTY_FileList, 2, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_Atomic32", js_MTY_Atomic32, 1, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_Atomic64", js_MTY_Atomic64, 1, JS_PROP_CONFIGURABLE),
    JS_OBJECT_DEF("MTY_ListNode", js_MTY_ListNode, 3, JS_PROP_CONFIGURABLE),
};
